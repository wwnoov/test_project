...
<head>
    ...
    <script>
        function validate() {
            ...
            var title = document.getElementById("title"); // Corrected the ID
            var content = document.getElementById("content"); // Corrected the ID
            ...
            if(title.value.trim() === "") { // Trimmed the value and corrected the ID
                alert("제목을 입력해 주세요");
                title.focus();
                return false;
            }

            if(content.value.trim() === "") { // Trimmed the value and corrected the ID
                alert("내용을 입력해 주세요");
                content.focus();
                return false;
            }
